...
const getData = async () => {
    let response = await fetch("/api/getPurchaseList/");
...
const ShoppingCartTable = ({
    ...
    const getImg = (product_type: string) => {
        return product_type === 'RAM' ? "/src/assets/images/ram.png" : product_type === 'HHD' ? "/src/assets/images/hdd.png" : "/src/assets/images/ssd.png";
    }
