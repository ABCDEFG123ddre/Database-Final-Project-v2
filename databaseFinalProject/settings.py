...
ALLOWED_HOSTS = ["127.0.0.1", "localhost", "8fdd-140-122-136-182.ngrok-free.app", "172.30.66.220"]
CSRF_TRUSTED_ORIGINS =["https://8fdd-140-122-136-182.ngrok-free.app"]
...
STATIC_URL = 'http://localhost:5173/static/'
